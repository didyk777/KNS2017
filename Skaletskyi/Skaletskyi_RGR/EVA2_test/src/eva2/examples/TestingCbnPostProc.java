...
public class TestingCbnPostProc {
	public static void main(String[] args) {
		// a simple bimodal target function, two optima near (1.7,0) and
		// (-1.44/0)
		...
		ppSols = OptimizerFactory.postProcessIndVec(new PostProcessParams(0, 0.05 , 5));
		...
		ppSols = OptimizerFactory.postProcessIndVec(new PostProcessParams(1000, 0.05, 5));
